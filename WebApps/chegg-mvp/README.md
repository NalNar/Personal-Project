# Chegg-style Student Portal MVP

A lightweight front-end MVP inspired by the requested Chegg-like student workflow.

## Features

- Student portal layout
- Document upload indicator
- Working AI-style chat assistant (rule-based for MVP)
